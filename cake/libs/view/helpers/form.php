		...
		switch ($name) {
			...
			case 'month':
				if ($options['monthNames']) {
					$data['01'] = __('Janeiro', true);
					$data['02'] = __('Fevereiro', true);
					$data['03'] = __('Marco', true);
					$data['04'] = __('Abril', true);
					$data['05'] = __('Maio', true);
					$data['06'] = __('Junho', true);
					$data['07'] = __('Julho', true);
					$data['08'] = __('Agosto', true);
					$data['09'] = __('Setembro', true);
					$data['10'] = __('Outubro', true);
					$data['11'] = __('Novembro', true);
					$data['12'] = __('Dezembro', true);
				} else {
					for ($m = 1; $m <= 12; $m++) {
