<h3>Total de Estudantes encontrados: <?php echo $paginator->counter(array('format' => '%count%')); ?></h3>
<br/>
<!--
...
<br/>
<h3><?php echo $html->link('Exportar resultados', '/estudantes/montar_relatorio', array('style' => 'color: #0000CC;')); ?></h3><br/>
-->



<h3><?php echo $html->link('Filtrar', '/estudantes/filtrar/formulario', array('style' => 'color: #0000CC;')); ?></h3>
<br/>
<hr/>
...
<table class="listagem">
    ...
    <?php foreach ($estudantes as $estudante): ?>
		...
		<tr class="linha_par">
		<?php endif; ?>
			<td style="text-align:center"><?php echo $estudante['Estudante']['ano_letivo'] ?></td>
