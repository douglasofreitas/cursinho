...
echo $form->create('Frequencia', array('action' => 'inserir_direto', 'class' => 'formulario2'));
...
foreach ($turmas as $turma)
{
    if(count($estudantes[$turma['Turma']['id']]) > 0){
?>	
	...
	<div id="<?php echo 'turma_'.$turma['Turma']['id']?>" class="filtro">
		<table class="listagem">
		    <tr class="listagem_header">
		        ...
		        <td style="width:160px">Presença</td>
		    </tr>
			...
			<?php if (is_array($estudantes[$turma['Turma']['id']])):?>
			    ...
			    <?php foreach ($estudantes[$turma['Turma']['id']] as $estudante):?>
					...
					<td style="width:70px">
						...
						<?php echo $form->radio('presente'.$num_estudante, array('Sim' => 'Presente', 'Nao' => 'Falta'), array('legend' => false, 'default' => 'Sim'));?>
						<?php $num_estudante++;?>
					</td>
