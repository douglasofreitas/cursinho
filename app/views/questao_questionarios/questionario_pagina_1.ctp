...
<br/>
<div id="questionario">
	<form id="formulario" method="post" action=<?php echo '"' . $html->url('/questao_questionarios/salvar_respostas/') 
		. $numero_inscricao . '/' . $ano . '/1' . '"'; ?>>
        ...
        <?php if(empty($_SESSION['Inscricao']['candidato_id'])): ?>
            ...
            <h4 <?php if($_SESSION['Auth']['User']['group_id'] != 1) {echo 'style="display:none"';} ?> >Escolher página:
