...
<br/><br/><br/>
<?php
	echo $form->create('CriteriosDaFaseClassificatoria', array('action' => 'alterar_criterios/'.$ano_fase, 'class' => 'formulario'));

	echo $form->hidden('criterios_da_fase_classificatoria_id');
