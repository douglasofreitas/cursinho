<h3>Total de candidatos inscritos: <?php echo $paginator->counter(array('format' => '%count%')); ?></h3>
<br/>
...
<br/>
<h3><?php echo $html->link('Exportar resultados', '/candidatos/montar_relatorio'); ?></h3><br/>
<h3><?php echo $html->link('Filtrar', '/candidatos/filtrar/formulario'); ?></h3>
<br/>
<?php 
    ...
    <?php foreach ($candidatos as $candidato): ?>
		...
		<?php endif; ?>
	        ...
	        <?php if ($candidato['Candidato']['nota_prova'] == null or $candidato['Candidato']['nota_prova'] == ''): ?>
				<td style="text-align:center"><?php echo $html->link('Em Branco', '/candidatos/preencher_prova/'.$candidato['Candidato']['numero_inscricao'].'/'.$candidato['Candidato']['ano']);?></td>
			<?php else: ?>
				<td style="text-align:center"><?php echo $html->link('Preenchido', '/candidatos/visualizar_respostas_questao_prova/'.$candidato['Candidato']['numero_inscricao'].'/'.$candidato['Candidato']['ano']);?></td>
			<?php endif; ?>
   		</tr>
    <?php endforeach; ?>
</table>
