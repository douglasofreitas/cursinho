...
class FpdfComponent extends Object
{
	...
	*                                                                              *
	*******************************************************************************/
	function FpdfComponent($orientation='P', $unit='mm', $format='A4')
	{
		//Some checks
		$this->_dochecks();
	...
	function AddTableCPV($headers, $width_cols, $data, $align = 'L')
	{
	...
	function Header()
	{
		if($this->tipo_header == 'ficha_inscricao')
		{

		}
		else
		{
			if($this->tipo_header == 'relatorio_prova')
			{
				//To be implemented in your own inherited class
			    //Arial bold 15
			    $this->SetFont('Arial','B',15);
			    //Title
			    $this->Cell(30,10, 'CPV - Curso Pré-Vestibular da UFSCar',0,0,'L');
			    //Line break
			    $this->Ln(20);
			}
			else
			{
				if($this->tipo_header == 'outros')
				{
					//$this->Image('logo_ufscar.jpg',10,10,38,38,jpg);
					/*
					$this->SetFont('Arial','B',14);
					$this->Cell(70,10, 'UNIVERSIDADE FEDERAL DE SÃO CARLOS',0,0,'L');
					$this->Cell(70,20, 'PRÓ REITORIA DE GRADUAÇÃO',0,0,'L');
					$this->Cell(70,30, 'PRÓ REITORIA DE EXTENSÃO',0,0,'L');
					$this->SetFont('Arial','B',12);
					$this->Cell(70,40, 'NÚCLEO DE EXTENSÃO UFSCAR-ESCOLA',0,0,'L');
					$this->SetFont('Arial','',10);
					$this->Cell(70,50, 'PROJETO DE EXTENSÃO CURSO PRÉ-VESTIBULAR DA UFSCAR',0,0,'L');
					$this->Cell(70,60, 'Via Washington Luiz, Km. 235 - Caixa Postal 676',0,0,'L');
					$this->Cell(70,70, 'Fones: (016) 3351-8433 Telefax: (016) 3351.2081 –',0,0,'L');
					$this->Cell(70,80, 'CEP 13565-905 - São Carlos - SP - Brasil',0,0,'L');
					$this->Cell(70,90, 'e.mail: cursinho.ufscar@gmail.com',0,0,'L');
					*/ 
				}
			}
		}
	...
	function header_tipo($tipo)
	{
		$this->tipo_header = $tipo;
	}
